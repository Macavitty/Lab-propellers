...
public class Karlson extends Hero {
    ...
    public void pressButton(double w, int illum){
        ...
        } catch (WeightException e){ System.out.print(e); }
    }
    ...
    */
        ...
        private double speed; // размер или аналогичный числовой параметр
        private double maxWeight; // грузоподъёмность
        private int efficiency; // кпд в процентах
        private int year; // время/дату рождения/создания объекта
        private ArrayList<String> fans;
        private String color;

        public Propeller(){}

        public Propeller(String model, double speed, double maxWeight, int efficiency, int year, ArrayList<String> fans) {
            this.fans = fans;
            this.model = model;
        ...
        public ArrayList<String> getFans() {return fans;}
        ...
        public void setFans(ArrayList<String> fans) {this.fans = fans;}
        ...
        public int compareTo(Propeller p) {
            return efficiency - p.getEfficiency();
        }
